...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    const aspect = this.imageAspectRatio || (700 / 900);
...
class App {
  ...
  onTouchMove(e) {
    ...
    if (this.isDown) {
      ...
      if (this.lastHoverX === undefined) this.lastHoverX = x;
      const distance = (this.lastHoverX - x) * (this.scrollSpeed * 0.025);
      
      if (this.container) {
        const rect = this.container.getBoundingClientRect();
        // Only move if hovering over the vertical bounds of the gallery
